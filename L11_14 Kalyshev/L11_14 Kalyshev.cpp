// L11_14 Kalyshev.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
char fileOut1[] = "C:\\Users\\yanka\\OneDrive\\stuff\\L11 Kalyshev\\out1.txt";
